# neuron-demo-customer
Event driven applications to simulate customer onboarding, updates, open and close events.
...
#docker run -it -p 6650:6650  -p 8080:8080 --rm --user 0:0 --mount source=pulsardata,target=/pulsar/data --mount source=pulsarconf,target=/pulsar/conf -e PULSAR_PREFIX_systemTopicEnabled=true -e PULSAR_PREFIX_topicLevelPoliciesEnabled=true apachepulsar/pulsar:2.10.0 bash
